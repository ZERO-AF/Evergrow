...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Valiance Keep Guard Post', nx: .547, ny: .733, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Warsong Hold Guard Post', nx: .412, ny: .542, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Taunka\'le Village Guard Post', nx: .708, ny: .426, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Fizzcrank Airstrip Guard Post', nx: .578, ny: .192, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Valiance Patrol', nx: .6, ny: .68, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Warsong Warband', nx: .35, ny: .62, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Valgarde Guard Post', nx: .544, ny: .585, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Vengeance Landing Guard Post', nx: .769, ny: .358, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Westguard Keep Guard Post', nx: .312, ny: .454, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'New Agamand Guard Post', nx: .5, ny: .733, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Fort Wildervar Guard Post', nx: .596, ny: .216, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Camp Winterhoof Guard Post', nx: .5, ny: .167, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Apothecary Camp Guard Post', nx: .452, ny: .292, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Steel Gate Guard Post', nx: .326, ny: .309, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Valgarde Patrol', nx: .6, ny: .55, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Vengeance Warband', nx: .72, ny: .42, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Wintergarde Keep Guard Post', nx: .774, ny: .354, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Agmar\'s Hammer Guard Post', nx: .386, ny: .453, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Stars\' Rest Guard Post', nx: .286, ny: .548, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Venomspite Guard Post', nx: .744, ny: .597, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Wintergarde Patrol', nx: .72, ny: .42, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Agmar\'s Warband', nx: .44, ny: .5, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Amberpine Lodge Guard Post', nx: .312, ny: .546, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Conquest Hold Guard Post', nx: .212, ny: .642, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Westfall Brigade Encampment Guard Post', nx: .547, ny: .317, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Camp Oneqwah Guard Post', nx: .638, ny: .455, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Amberpine Patrol', nx: .38, ny: .6, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Conquest Warband', nx: .28, ny: .7, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
    { kind: 'hound', weight: 3 }, { kind: 'stalker', weight: 2 },
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'camp', name: 'Argent Alliance Camp', nx: .3, ny: .5, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Argent Horde Camp', nx: .68, ny: .6, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
    { kind: 'stalker', weight: 3 }, { kind: 'caster', weight: 2 },
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'camp', name: 'Sholazar Alliance Camp', nx: .3, ny: .45, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Sholazar Horde Camp', nx: .7, ny: .5, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Windrunner\'s Overlook Guard Post', nx: .707, ny: .546, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Sunreaver\'s Command Guard Post', nx: .767, ny: .453, faction: 'horde', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Frosthold Guard Post', nx: .309, ny: .688, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Grom\'arsh Crash-Site Guard Post', nx: .363, ny: .5, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Frosthold Patrol', nx: .36, ny: .62, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Grom\'arsh Warband', nx: .42, ny: .55, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'camp', name: 'Skybreaker Forward Camp', nx: .6, ny: .5, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Orgrim\'s Hammer Forward Camp', nx: .35, ny: .45, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
    { kind: 'stalker', weight: 3 }, { kind: 'caster', weight: 2 },
    { kind: 'brute', weight: 2 }, { kind: 'hound', weight: 1 },
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Valiance Landing Camp Guard Post', nx: .711, ny: .595, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Warsong Camp Guard Post', nx: .259, ny: .595, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Valiance Patrol', nx: .65, ny: .5, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Warsong Patrol', nx: .35, ny: .5, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
