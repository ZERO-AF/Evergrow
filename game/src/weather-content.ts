...
export type WeatherKind = 'rain' | 'snow' | 'ash' | 'sand' | 'motes' | 'none';
...
const CLEAR: WeatherRecipe = { kind: 'none', colors: [], fall: 0, drift: 0, sway: 0, density: 0, size: 0, alpha: 0, streak: 0 };

export const WEATHER_RECIPES: Readonly<Record<BiomeId, WeatherRecipe>> = {
  frostpine: { kind: 'snow', colors: ['#f4f8ff', '#dbe8f2', '#ffffff'], fall: 46, drift: 14, sway: 26, density: .85, size: 2.4, alpha: .8, streak: 0 },
  emberfall: { kind: 'ash', colors: ['#b8a89a', '#8f8378', '#e8a06a'], fall: -14, drift: 20, sway: 30, density: .7, size: 1.6, alpha: .55, streak: 0 },
  ...
  deadwood: { kind: 'motes', colors: ['#c9d4c2', '#9fb4a8'], fall: 6, drift: 8, sway: 20, density: .25, size: 1.4, alpha: .5, streak: 0 },
  autumn: { kind: 'motes', colors: ['#e8c87a', '#d4a85c'], fall: 10, drift: 14, sway: 24, density: .3, size: 1.5, alpha: .55, streak: 0 },
  highlands: { kind: 'motes', colors: ['#d4d0e0', '#b8bcd0'], fall: 8, drift: 30, sway: 22, density: .2, size: 1.3, alpha: .45, streak: 0 },
  steppe: CLEAR,
};
