...
// [GENERATED:ZONES]
  ...
  'hinterlands': zone('hinterlands','The Hinterlands','eastern-kingdoms', 160000,220000,60000,80000, 40,50, 'contested','forested troll highlands', {borders:{north:'western-plaguelands',south:'hillsbrad',east:null,west:null},cities:[{name:'Aerie Peak',faction:'alliance',nx:0.15,ny:0.5,tier:'town'},{name:'Revantusk Village',faction:'horde',nx:0.8,ny:0.8,tier:'town'}],dungeons:[],docks:[],flightpaths:[{name:'Aerie Peak',faction:'alliance',nx:0.15,ny:0.5},{name:'Revantusk Village',faction:'horde',nx:0.8,ny:0.8}]}),
