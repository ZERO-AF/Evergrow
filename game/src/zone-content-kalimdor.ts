...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Darnassus Guard Post', nx: .361, ny: .305, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Dolanaar Guard Post', nx: .538, ny: .532, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Rut\'theran Village Guard Post', nx: .548, ny: .894, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Starbreeze Village Guard Post', nx: .643, ny: .517, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Shadowglen Guard Post', nx: .573, ny: .396, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Blood Watch Guard Post', nx: .5, ny: .526, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Vindicator\'s Rest Guard Post', nx: .312, ny: .545, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'The Exodar Guard Post', nx: .318, ny: .409, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Azure Watch Guard Post', nx: .5, ny: .533, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Odesyus\' Landing Guard Post', nx: .462, ny: .708, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Stillpine Hold Guard Post', nx: .453, ny: .237, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
    { kind: 'stalker', weight: 4 }, { kind: 'hound', weight: 3 }, { kind: 'wisp', weight: 2 },
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Starfall Village Guard Post', nx: .452, ny: .325, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Auberdine Guard Post', nx: .41, ny: .357, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Grove of the Ancients Guard Post', nx: .5, ny: .741, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Bloodvenom Post Guard Post', nx: .407, ny: .546, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Talonbranch Glade Guard Post', nx: .548, ny: .312, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Talonbranch Patrol', nx: .62, ny: .22, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Bloodvenom Warband', nx: .32, ny: .62, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Valormok Guard Post', nx: .308, ny: .5, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Talrendis Point Guard Post', nx: .157, ny: .598, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Talrendis Forward Camp', nx: .2, ny: .68, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Valormok Warband', nx: .38, ny: .45, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Astranaar Guard Post', nx: .406, ny: .544, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Splintertree Post Guard Post', nx: .715, ny: .5, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Zoram\'gar Outpost Guard Post', nx: .085, ny: .451, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Forest Song Guard Post', nx: .845, ny: .403, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Maestra\'s Post Guard Post', nx: .286, ny: .5, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Silverwind Refuge Guard Post', nx: .5, ny: .637, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Silverwing Sentinel Camp', nx: .5, ny: .45, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Warsong Forward Camp', nx: .8, ny: .55, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Orgrimmar Guard Post', nx: .452, ny: .112, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Razor Hill Guard Post', nx: .515, ny: .54, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Sen\'jin Village Guard Post', nx: .548, ny: .81, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Valley of Trials Guard Post', nx: .424, ny: .673, faction: 'horde', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Stonetalon Peak Guard Post', nx: .306, ny: .161, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Sun Rock Retreat Guard Post', nx: .542, ny: .585, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Stonetalon Patrol', nx: .35, ny: .25, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Sun Rock Warband', nx: .6, ny: .68, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'The Crossroads Guard Post', nx: .5, ny: .533, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Mor\'shan Rampart Guard Post', nx: .559, ny: .063, faction: 'horde', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Camp Taurajo Guard Post', nx: .412, ny: .591, faction: 'horde', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Theramore Isle Guard Post', nx: .737, ny: .547, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Brackenwall Village Guard Post', nx: .358, ny: .31, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'North Point Tower Guard Post', nx: .481, ny: .229, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Theramore Sentry Camp', nx: .68, ny: .62, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Brackenwall Warband', nx: .42, ny: .38, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Nijel\'s Point Guard Post', nx: .597, ny: .112, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Shadowprey Village Guard Post', nx: .263, ny: .689, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Ghost Walker Post Guard Post', nx: .541, ny: .541, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Nijel\'s Point Patrol', nx: .55, ny: .18, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Shadowprey Warband', nx: .3, ny: .62, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Thunder Bluff Guard Post', nx: .455, ny: .373, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Bloodhoof Village Guard Post', nx: .5, ny: .599, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Camp Narache Guard Post', nx: .442, ny: .765, faction: 'horde', members: ['brute', 'archer', 'brute'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Freewind Post Guard Post', nx: .453, ny: .459, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Shimmering Flats Camp', nx: .78, ny: .72, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Freewind Warband', nx: .52, ny: .5, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
...
defineZoneContent({
  ...
  camps: [
    ...
    { kind: 'watchtower', name: 'Feathermoon Stronghold Guard Post', nx: .163, ny: .548, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Camp Mojache Guard Post', nx: .737, ny: .453, faction: 'horde', members: ['brute', 'archer', 'brute'] },
    { kind: 'watchtower', name: 'Thalanaar Guard Post', nx: .891, ny: .354, faction: 'alliance', members: ['brute', 'archer', 'brute'] },
    { kind: 'camp', name: 'Feathermoon Patrol', nx: .22, ny: .6, faction: 'alliance', members: ['brute', 'archer', 'caster', 'stalker'] },
    { kind: 'camp', name: 'Mojache Warband', nx: .68, ny: .52, faction: 'horde', members: ['brute', 'archer', 'caster', 'stalker'] },
  ],
  spawns: [
