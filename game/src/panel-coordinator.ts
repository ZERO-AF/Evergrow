...
const OPEN_FROM: Record<PanelPhase, readonly GamePhase[]> = {
 ...
 dungeonFinder: ['playing','paused'], auctionHouse: ['playing','paused'], guild: ['playing','paused'], mailbox: ['playing'], holiday: ['playing'], calendar: ['playing','paused'], trainer: ['playing'], quartermaster: ['playing'], socketing: ['playing','paused','character','service'],
};
