...
export const ENEMY_ITEM_KIND_WEIGHTS: Readonly<Record<EnemyKind, Readonly<Record<Exclude<ItemKind, 'riftKey' | 'consumable'>, number>>>> = Object.freeze({
  thornReaver: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 2, orb: 2, relic: 2, weapon: 12, shield: 5, head: 5, chest: 7, gloves: 13, legs: 10, boots: 22, cloak: 10, amulet: 5, ring: 5 }),
  mireSpitter: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 10, orb: 10, relic: 2, weapon: 26, shield: 3, head: 6, chest: 6, gloves: 5, legs: 5, boots: 5, cloak: 14, amulet: 4, ring: 4 }),
  frostRevenant: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 2, orb: 2, relic: 2, weapon: 21, shield: 18, head: 10, chest: 15, gloves: 7, legs: 10, boots: 5, cloak: 3, amulet: 2, ring: 3 }),
  emberAcolyte: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 10, orb: 10, relic: 2, weapon: 26, shield: 3, head: 6, chest: 6, gloves: 5, legs: 5, boots: 5, cloak: 14, amulet: 4, ring: 4 }),
  duneScuttler: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 2, orb: 2, relic: 2, weapon: 12, shield: 5, head: 5, chest: 7, gloves: 13, legs: 10, boots: 22, cloak: 10, amulet: 5, ring: 5 }),
  stormSentinel: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 10, orb: 10, relic: 2, weapon: 18, shield: 3, head: 8, chest: 4, gloves: 4, legs: 4, boots: 6, cloak: 15, amulet: 8, ring: 8 }),
  briarMatriarch: Object.freeze({ charm: CHARM_DROP_WEIGHT, weapon: 22, shield: 6, grimoire: 4, orb: 4, relic: 2, head: 8, chest: 10, gloves: 7, legs: 7, boots: 7, cloak: 7, amulet: 8, ring: 8 }),
  ashColossus: Object.freeze({ charm: CHARM_DROP_WEIGHT, weapon: 22, shield: 6, grimoire: 4, orb: 4, relic: 2, head: 8, chest: 10, gloves: 7, legs: 7, boots: 7, cloak: 7, amulet: 8, ring: 8 }),
  graveMarshal: Object.freeze({ charm: CHARM_DROP_WEIGHT, weapon: 22, shield: 6, grimoire: 4, orb: 4, relic: 2, head: 8, chest: 10, gloves: 7, legs: 7, boots: 7, cloak: 7, amulet: 8, ring: 8 }),
  warden: Object.freeze({ charm: CHARM_DROP_WEIGHT, weapon: 22, shield: 6, grimoire: 4, orb: 4, relic: 2, head: 8, chest: 10, gloves: 7, legs: 7, boots: 7, cloak: 7, amulet: 8, ring: 8 }),
  goblin: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 1, orb: 1, relic: 2, weapon: 28, shield: 8, head: 5, chest: 5, gloves: 8, legs: 8, boots: 14, cloak: 6, amulet: 3, ring: 11 }),
  goblinChief: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 1, orb: 1, relic: 2, weapon: 28, shield: 14, head: 12, chest: 10, gloves: 6, legs: 6, boots: 6, cloak: 6, amulet: 3, ring: 5 }),
  stalker: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 2, orb: 2, relic: 2, weapon: 26, shield: 6, head: 8, chest: 8, gloves: 10, legs: 8, boots: 12, cloak: 8, amulet: 3, ring: 5 }),
  brute: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 2, orb: 2, relic: 2, weapon: 21, shield: 18, head: 10, chest: 15, gloves: 7, legs: 10, boots: 5, cloak: 3, amulet: 2, ring: 3 }),
  hound: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 2, orb: 2, relic: 2, weapon: 12, shield: 5, head: 5, chest: 7, gloves: 13, legs: 10, boots: 22, cloak: 10, amulet: 5, ring: 5 }),
  archer: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 2, orb: 2, relic: 2, weapon: 32, shield: 3, head: 7, chest: 6, gloves: 11, legs: 7, boots: 10, cloak: 8, amulet: 4, ring: 6 }),
  wisp: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 10, orb: 10, relic: 2, weapon: 18, shield: 3, head: 8, chest: 4, gloves: 4, legs: 4, boots: 6, cloak: 15, amulet: 8, ring: 8 }),
  caster: Object.freeze({ charm: CHARM_DROP_WEIGHT, grimoire: 10, orb: 10, relic: 2, weapon: 26, shield: 3, head: 6, chest: 6, gloves: 5, legs: 5, boots: 5, cloak: 14, amulet: 4, ring: 4 }),
});
...
export const BIOME_PROFILE_WEIGHTS: Readonly<Record<BiomeId, BiomeProfileWeights>> = Object.freeze({
  deadwood: Object.freeze({
    weapon: Object.freeze({ longsword: 3, 'hand-axe': 1, 'flanged-mace': 2, 'rondel-dagger': 1,
      ...
      'razor-claw': 1, 'duelist-katar': 1, 'talon-fist': 1, 'vanguard-halberd': 2, 'sentinel-glaive': 2, 'warsong-spear': 2, 'dwarven-rifle': 1, 'tavern-blunderbuss': 2 }),
  ...
  verdant: Object.freeze({
    weapon: Object.freeze({ longsword: 1, 'hand-axe': 2, 'flanged-mace': 1, 'rondel-dagger': 3,
      ...
      'razor-claw': 3, 'duelist-katar': 2, 'talon-fist': 3, 'vanguard-halberd': 1, 'sentinel-glaive': 2, 'warsong-spear': 2, 'dwarven-rifle': 1, 'tavern-blunderbuss': 1 }),
  ...
  swamp: Object.freeze({
    weapon: Object.freeze({ longsword: 1, 'hand-axe': 1, 'flanged-mace': 1, 'rondel-dagger': 2,
      ...
      'razor-claw': 1, 'duelist-katar': 1, 'talon-fist': 1, 'vanguard-halberd': 1, 'sentinel-glaive': 1, 'warsong-spear': 3, 'dwarven-rifle': 1, 'tavern-blunderbuss': 3 }),
  ...
  frostpine: Object.freeze({
    weapon: Object.freeze({ longsword: 1, 'hand-axe': 2, 'flanged-mace': 1, 'rondel-dagger': 1,
      ...
      'razor-claw': 1, 'duelist-katar': 1, 'talon-fist': 1, 'vanguard-halberd': 2, 'sentinel-glaive': 2, 'warsong-spear': 1, 'dwarven-rifle': 3, 'tavern-blunderbuss': 1 }),
  ...
  emberfall: Object.freeze({
    weapon: Object.freeze({ longsword: 1, 'hand-axe': 2, 'flanged-mace': 3, 'rondel-dagger': 1,
      ...
      'razor-claw': 1, 'duelist-katar': 1, 'talon-fist': 1, 'vanguard-halberd': 2, 'sentinel-glaive': 1, 'warsong-spear': 1, 'dwarven-rifle': 2, 'tavern-blunderbuss': 4 }),
  ...
  steppe: Object.freeze({
    weapon: Object.freeze({ longsword: 2, 'hand-axe': 3, 'flanged-mace': 1, 'rondel-dagger': 4,
      ...
      'razor-claw': 2, 'duelist-katar': 3, 'talon-fist': 2, 'vanguard-halberd': 2, 'sentinel-glaive': 2, 'warsong-spear': 3, 'dwarven-rifle': 2, 'tavern-blunderbuss': 2 }),
    ...
    weapon: Object.freeze({ longsword: 2, 'hand-axe': 3, 'flanged-mace': 1, 'rondel-dagger': 4,
      greatblade: 1, greataxe: 1, 'grave-maul': 1, 'thorn-shortbow': 3, 'crescent-recurve': 3,
      'warden-longbow': 2, 'ember-staff': 1, 'rime-staff': 1, 'storm-staff': 2, 'cinder-wand': 1, 'hoarfrost-wand': 1, 'spark-wand': 2, 'star-wand': 2,
      'razor-claw': 1, 'duelist-katar': 2, 'talon-fist': 1, 'vanguard-halberd': 2, 'sentinel-glaive': 1, 'warsong-spear': 2, 'dwarven-rifle': 3, 'tavern-blunderbuss': 3 }),
    grimoire: Object.freeze({ 'ember-codex': 1, 'rime-folio': 1, 'astral-grimoire': 2 }),
    orb: Object.freeze({ 'cinder-orb': 1, 'rime-orb': 1, 'astral-orb': 2 }),
    shield: Object.freeze({ 'iron-buckler': 4, 'vigil-kite': 2, 'bastion-tower': 1 }),
    ...
    weapon: Object.freeze({ longsword: 2, 'hand-axe': 3, 'flanged-mace': 1, 'rondel-dagger': 4,
      greatblade: 1, greataxe: 1, 'grave-maul': 1, 'thorn-shortbow': 3, 'crescent-recurve': 3,
      'warden-longbow': 2, 'ember-staff': 1, 'rime-staff': 1, 'storm-staff': 2, 'cinder-wand': 1, 'hoarfrost-wand': 1, 'spark-wand': 2, 'star-wand': 2,
      'razor-claw': 3, 'duelist-katar': 2, 'talon-fist': 3, 'vanguard-halberd': 2, 'sentinel-glaive': 3, 'warsong-spear': 2, 'dwarven-rifle': 1, 'tavern-blunderbuss': 1 }),
    grimoire: Object.freeze({ 'ember-codex': 1, 'rime-folio': 1, 'astral-grimoire': 2 }),
    orb: Object.freeze({ 'cinder-orb': 1, 'rime-orb': 1, 'astral-orb': 2 }),
    shield: Object.freeze({ 'iron-buckler': 4, 'vigil-kite': 2, 'bastion-tower': 1 }),
  }),
  highlands: Object.freeze({
    weapon: Object.freeze({ longsword: 3, 'hand-axe': 1, 'flanged-mace': 3, 'rondel-dagger': 1,
      ...
      'razor-claw': 1, 'duelist-katar': 1, 'talon-fist': 1, 'vanguard-halberd': 3, 'sentinel-glaive': 3, 'warsong-spear': 2, 'dwarven-rifle': 4, 'tavern-blunderbuss': 1 }),
