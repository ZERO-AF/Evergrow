...
export const WOW_CLASSES: Readonly<Record<WowClassId, WowClassDef>> = Object.freeze({
  warrior: Object.freeze({
    ...
    weapons: ['sword', 'axe', 'mace', 'dagger', 'fist', 'polearm', 'staff', 'bow', 'gun'] as const, twoHandedMelee: true,
  ...
  paladin: Object.freeze({
    ...
    weapons: ['sword', 'axe', 'mace', 'polearm'] as const, twoHandedMelee: true,
  ...
  hunter: Object.freeze({
    ...
    weapons: ['bow', 'gun', 'sword', 'axe', 'mace', 'dagger', 'fist', 'polearm'] as const, twoHandedMelee: true,
  ...
  rogue: Object.freeze({
    ...
    weapons: ['dagger', 'sword', 'axe', 'mace', 'fist', 'gun'] as const, twoHandedMelee: false,
  ...
  deathKnight: Object.freeze({
    ...
    gainOnDeal: 0, gainOnHit: 0, gcd: 1.5, armorStyle: 'plate',
    weapons: ['sword', 'axe', 'mace', 'dagger', 'polearm'] as const, twoHandedMelee: true,
  ...
  shaman: Object.freeze({
    ...
    resource: 'mana', resourceLabel: 'Mana', resourceCap: 0, resourceRegen: 0, resourceDecay: 0,
    gainOnDeal: 0, gainOnHit: 0, gcd: 1.5, armorStyle: 'leather',
    weapons: ['axe', 'mace', 'staff', 'fist'] as const, twoHandedMelee: true,
  ...
  druid: Object.freeze({
    ...
    resource: 'mana', resourceLabel: 'Mana', resourceCap: 0, resourceRegen: 0, resourceDecay: 0,
    gainOnDeal: 0, gainOnHit: 0, gcd: 1.5, armorStyle: 'leather',
    weapons: ['staff', 'mace', 'dagger', 'fist', 'polearm'] as const, twoHandedMelee: true,
