...
export const ELEMENTS = ['fire', 'frost', 'lightning', 'arcane', 'holy', 'shadow', 'nature'] as const satisfies readonly Element[];
export const RESISTANCE_STATS = ['fireResistance', 'frostResistance', 'lightningResistance', 'arcaneResistance', 'holyResistance', 'shadowResistance', 'natureResistance', 'allResistance'] as const;
export const RESISTANCE_LABELS: Readonly<Record<ResistanceStat, string>> = Object.freeze({
  ...
  arcaneResistance: 'Arcane resistance', holyResistance: 'Holy resistance', shadowResistance: 'Shadow resistance',
  natureResistance: 'Nature resistance', allResistance: 'All elemental resistances',
});
...
export const RESISTANCE_AFFIXES: readonly AffixDefinition[] = Object.freeze([
  ...
  { name: 'Lightward', stat: 'holyResistance', base: 10, growth: .12, weight: .15 },
  { name: 'Duskward', stat: 'shadowResistance', base: 10, growth: .12, weight: .15 },
  { name: 'Wildward', stat: 'natureResistance', base: 10, growth: .12, weight: .15 },
...
export function deriveResistances(modifiers: StatModifiers): Record<Element, number> {
  ...
  return { fire: resistance('fire'), frost: resistance('frost'), lightning: resistance('lightning'), arcane: resistance('arcane'),
    holy: resistance('holy'), shadow: resistance('shadow'), nature: resistance('nature') };
}
...
const PROJECTILE_DAMAGE: Record<ProjectileStyle, DamageType> = Object.freeze({
  ...
  holy: 'holy', shadow: 'shadow', nature: 'nature',
});
