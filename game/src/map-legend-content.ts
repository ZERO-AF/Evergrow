...
export const MAP_LEGEND_GROUPS: readonly MapLegendGroup[] = [
  { id: 'services', label: 'NPCs & services', entries: [poi('blacksmith', 'Trade and improve weapons'), poi('jeweler', 'Jewelry and accessories'), poi('enchanter', 'Magic gear and enchantments'), poi('gambler', 'Buy unidentified equipment'), poi('stash', 'Your personal item storage'), poi('mailbox', 'Send and collect mail')] },
  { id: 'towns', label: 'Towns & travel', entries: [poi('town', 'Settlement, village or city'), poi('portal', 'A travel portal'), poi('merchant', 'Merchant location'), poi('inn', 'An inn building'), poi('chapel', 'A chapel building'), poi('faire', 'The Darkmoon Faire carnival')] },
  { id: 'encounters', label: 'Encounters & dungeons', entries: [poi('camp', 'A hostile encampment'), poi('bossLair', 'A powerful wilderness foe'), poi('rift', 'An entrance to a Crimson Rift'), poi('dungeon', 'An underground entrance'), poi('cursedChest', 'A dangerous treasure encounter'), poi('ruinedChapel', 'An encounter at a ruined chapel'), poi('beastDen', 'A den occupied by beasts'), poi('quarry', 'An encounter in a quarry'), poi('hamlet', 'A hostile occupied settlement'), poi('crossing', 'A guarded crossing'), poi('corruptedGrove', 'A blighted woodland encounter'), poi('necropolis', 'A Scourge invasion site')] },
