...
type Source=Pick<Enemy,'kind'|'rank'> & Partial<Pick<Enemy,'lootSeed'|'rift'|'affixState'>>;
...
export function enemyVisualScale(e:Source):number{
  ...
  return (isBossKind(e.kind)?1:e.rank==='elite'?1.28:e.rank==='veteran'?1.14:1)*avenger;
}
