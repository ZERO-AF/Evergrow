...
const STAT_GLYPHS: Readonly<Record<StatKey, StatGlyph>> = Object.freeze({
  ...
  lightningResistance: { engraving: 'shield', unit: 10 }, arcaneResistance: { engraving: 'shield', unit: 10 },
  holyResistance: { engraving: 'shield', unit: 10 }, shadowResistance: { engraving: 'shield', unit: 10 },
  natureResistance: { engraving: 'shield', unit: 10 }, allResistance: { engraving: 'shield', unit: 3 },
  ...
  maxHp: { engraving: 'heart', unit: 8 }, maxHpPercent: { engraving: 'heart', unit: 8 },
  maxMana: { engraving: 'mana', unit: 7 },
  armor: { engraving: 'shield', unit: 6 }, armorPercent: { engraving: 'shield', unit: 6 },
