...
test('map mode is established before opening the view and only hold mode advances simulation', () => {
 ...
 character: panel, skills: panel, journeys: panel, event: panel, service: panel, stable: panel, chronicle: panel, achievements: panel, questLog: panel, professions: panel, glyphs: panel, spellbook: panel, stats: panel, reputation: panel, transmog: panel, arena: panel, pvpVendor: panel, badgeVendor: panel, dungeonFinder: panel, auctionHouse: panel, guild: panel, mailbox: panel, holiday: panel, calendar: panel, trainer: panel, quartermaster: panel, socketing: panel, net: panel }, {
